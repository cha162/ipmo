...
<body>
        ...
        <div id="mainAppContainer" class="main_content">
            ...
            <div class="container mt-4">
                ...
                <div class="row">           <div class="col-md-5">
                            ...
                            <label for="branchesDropdown" style="margin-top:10px;">Select Branch:</label>
                            <select id="branchesDropdown" class="form-control">
                                <option value="">Select Branch</option>
                                <!-- Options will be populated using JavaScript -->
                            </select>

                            <!-- Dropdown to select programs -->
                            <label for="bcprogramsDropdown" style="margin-top:8px; width: 100%;">Select Program:</label>
                            <select id="bcprogramsDropdown" class="form-control" disabled style=" width: 100%;">
    ...
    <script src="js/branch_record.js"></script>
