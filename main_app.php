        ...
        <div id="mainAppContainer" class="main_content">
            <div class="info">
                <div class="container mt-4">
                    <h2> <strong>Main Applications</strong></h2>
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-5">
                            <label for="collegesDropdown">Select College:</label>
                            <select id="collegesDropdown" class="form-control">
                        ...
                        <div class="col-md-5">
                            <label for="programsDropdown">Select Program:</label>
                            <select id="programsDropdown" class="form-control" disabled>
                    ...
                    <div class="table-responsive mt-4">
                        <table id="mainAppTable" class="table table-striped">
                ...
                <div class="table-responsive mt-4 table-hover" style="margin-left: 50px;">
            ...
            <div id="pdfModal">
                <div id="pdfContent">
                    <iframe id="pdfFrame" width="100%" height="650px"></iframe>
            ...
            <script src="js/populate_table.js"></script>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height: 300px; overflow-y: auto;">
                    ...
                    $sql = "SELECT af.*, a.ThesisTitle
                            FROM mainapplicationfile AS af
                            LEFT JOIN mainapplication AS a ON af.MAppID = a.MAppID
                            WHERE a.Remarks = 'Complete'";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<input type='hidden' name='table' value='main'>";
                        echo "<table>";
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><input type='checkbox' name='selected[]' value='" . $row["MAppID"] . "'></td>";
                            echo "</tr>";
                        }
                        echo "</table>";
                        echo "<br>";
