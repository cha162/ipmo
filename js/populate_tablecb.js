...
remarksDropdown.addEventListener('change', function () {
    ...
    if (selectedStatus === 'clear') {
        ...
        fetch(`get_remarkscb.php?status=${selectedStatus}`)
